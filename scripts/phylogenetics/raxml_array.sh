#!/bin/bash
#SBATCH -J raxml4
#SBATCH -o raxml_%A_%a.out
#SBATCH -e raxml_%A_%a.err
#SBATCH -p defq
#SBATCH -n 1
#SBATCH -N 1
...
cd /lustre/groups/cbi/Projects/covid19/raxml0508/

FILES=($(cat /lustre/groups/cbi/Projects/covid19/raxml0508/raxml_names))
